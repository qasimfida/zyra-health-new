...
export const basicCertificationsData = [
  {
...
export const specialityCertificationsData = [
  {
...
export const otherCertificationsData = [
  {
...
export const iconTypes = {
  info: <DocumentTagIcon className="w-5 h-5" aria-hidden="true" />,
...
export const educationIcons = {
  info: <DocumentTagIcon className="w-5 h-5" aria-hidden="true" />,
  success: <PhoneIcon className="w-5 h-5" aria-hidden="true" />,
  warning: <WarningTagIcon className="w-5 h-5" aria-hidden="true" />,
  danger: <PhoneDisconnectIcon className="w-5 h-5" aria-hidden="true" />,
};
