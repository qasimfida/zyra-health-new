  ...
  return (
    <div className="hidden md:flex lg:flex bg-white top-[5rem] sticky py-8 px-5 w-60 rounded-2xl flex-col min-h-[calc(100vh-20.5rem)] h-auto justify-between z-10 gap-52">
      <div className="flex flex-col items-center w-full gap-1">
        ...
        <div className="flex items-center w-52 h-12 bg-primary-default text-white justify-start rounded-2xl text-body cursor-pointer hover:text-white hover:bg-primary-light">
